...
function hashRoute() {
  ...
  return ["home", "learn", "cycle", "save", "life", "map", "sdg6", "quiz", "pledge", "pledges", "about", "sources", "links", "team", "news", "articles", "reports", "signin", "edit"].includes(h) ? h : "home";
}
...
function pageLinks() {
  return hero(TX.linksK, t(TX.linksT), TX.linksL) +
...
const pages = {
  ...
  pledges: pagePledges, signin: pageSignin, edit: pageEdit, links: pageLinks, sources: pageSources,
};
